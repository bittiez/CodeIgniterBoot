...
###################
I have combined CodeIgniter **3.0.3** with Bootstrap **3.3.5** and a basic template into one project to make starting a new project even faster and easier then standalone CodeIgniter. Feel free to use as you want, I will try to keep it up to date with the most recent releases of CodeIgniter and Bootstrap.
